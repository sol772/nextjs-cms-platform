...
const SelectBox = React.forwardRef<HTMLButtonElement, SelectBoxProps>(
    (
        ...
        const boxClass = twMerge(
            "h-[48px] w-auto min-w-[160px] bg-[#fff] px-[12px] shadow-none border-none text-[16px] ring-[#D9D9D9] rounded-[8px] leading-1 ring-inset ring-1 focus:ring-1 focus:ring-primary focus:ring-offset-0 data-[state=open]:ring-primary data-[placeholder]:text-[#999]",
            triggerClassName,
        );
