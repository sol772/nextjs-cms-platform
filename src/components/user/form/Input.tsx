...
const Input = forwardRef<HTMLInputElement, InputProps>(
    (
        ...
        const inputStyle = twMerge(
            "w-full h-[48px] px-[12px] text-[#222] border border-[#D9D9D9] rounded-[8px] focus:border-primary placeholder:text-[#9F9FA5] disabled:bg-[#F8F8F8] transition duration-200",
            className,
        );
        return (
            <>
